...
const stepsData = [
  {
    ...
    description:
      "A simple one-time setup. Just verify your employment details and link your bank account to receive funds.",
  },
  {
    number: "02",
    ...
    description: (
      <>
        Instantly transfer your earned pay to your account, anytime. No
        interest, just one small flat fee per transaction.
      </>
    ),
  },
  {
...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <div
        id="individuals"
        className="bg-yellow-300 text-black py-20 px-5 flex flex-col items-center font-sans"
      >
        <h2 className="text-4xl font-bold mb-16">How it works</h2>

        <div
          ref={targetRef}
          className="flex flex-col gap-10 max-w-md text-center mb-16 relative"
        >
